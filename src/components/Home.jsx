  ...
  return (
    <div className='h-screen w-full bg-primary'>
      <div className='max-w-[1000px] text-left mx-auto px-8 flex flex-col justify-center h-full font-normal'>
        ...
        <p className='text-[#8892b0] font-light mt-4'>I have an Msc. in Software engineering from EPITA. I have a passion for building web applications and solving complex problems. I'm currently looking for a full-time position as a software engineer.</p>
        <div>
